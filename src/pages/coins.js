    ...
    const handleButtonClick = () => {
        Swal.fire({
            ...
            if(result.isConfirmed){
                ...
                // something to update backend and frontend wallet
            }
        })
    }
    return (
        <div class="p-5">
            ...
            <div class="flex-col pt-5 space-y-3 pb-5">
                ...
                <button onClick={handleButtonClick} class="flex bg-zinc-800 hover:bg-zinc-900 rounded border-stone-500 border-2">
